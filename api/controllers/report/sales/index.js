...
const fetchAllReportSales = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const total = yield prisma_1.prisma.report_sales.count({
            where: filter
        });
...
const CreateReportSales = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { reporter, non_cash, expenses, total_income, total_cash, total_non_cash, total_expenses } = req.body;
    try {
        ...
        yield prisma_1.prisma.$transaction((prisma) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield prisma.expenses.createMany({
                data: expenses.map((data) => (Object.assign(Object.assign({}, data), { report_id: report.id }))),
            });
        }));
